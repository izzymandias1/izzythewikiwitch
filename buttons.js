...
let buttonsContainer = `
        <div class="buttonrow">
            <div class="buttoncolumn"><img loading="lazy" src="images/blinkies/DO NOT GO GENTLY.gif"></div>
            <div class="buttoncolumn"><img loading="lazy" src="images/blinkies/dear oh deergirl.gif"></div>
            <div class="buttoncolumn"><img loading="lazy" src="images/blinkies/sick as hell.gif"></div>
        </div>
        <div class="buttonrow">
            <div class="buttoncolumn"><img loading="lazy" src="images/blinkies/take the funny estrogen.gif"></div>
            <div class="buttoncolumn"><img loading="lazy" src="images/blinkies/pass the yuri.gif"></div>
        ...
        <a href="https://blinkies.cafe"><img src="images/blinkies/blinkies credit.gif"</a>`
document.getElementById("buttonscontainer").innerHTML = buttonsContainer;